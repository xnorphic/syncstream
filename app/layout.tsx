...
export const metadata: Metadata = {
  ...
  description:
    'Analyze Claude Skills (system prompts) for prompt injections, jailbreaks, and security risks using vector similarity and LLM analysis. Free, instant AI security scanning.',
  keywords: [
